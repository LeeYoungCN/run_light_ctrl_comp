...
public:
    ...
    VOS_VOID SetColor(LightColor lightColor, VOS_FLOAT brightPct = MAX_BRIGHT_PERCENT);
...
private:
    ...
    VOS_VOID CtrlBreathLightColor(LightColor lightColor, VOS_FLOAT brightPct);
    VOS_VOID CtrlBreathLightGroupColor(LightColor lightColor, VOS_FLOAT brightPct);
    VOS_VOID CtrlBreathLightStatus(BreathLightPara lightPara, LightStatus LightStatus, VOS_FLOAT brightPct);
